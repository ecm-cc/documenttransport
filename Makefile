APP_NAME=able-documenttransport
...
build-lambda: test
	zip -X -r ./dist/lambda.zip *.js classes node_modules modules routes views -x node_modules/esl*/**\* node_modules/lodash/**\* node_modules/ajv/**\* node_modules/esquery/**\*
